...
- [**Trending AI**](https://trendingai.cn) — Global tech trends, fast-picked by AI（全球技术热点，AI 精选速递）
- [**Tono**](https://tonote.app) — Simply capture, never lose.（简单记，不会丢）
...
- [**loginbase**](https://github.com/HarlonWang/loginbase) — Self-hosted login foundation（自托管登录底座）· KMP 客户端 [loginbase-kt](https://github.com/HarlonWang/loginbase-kt)
